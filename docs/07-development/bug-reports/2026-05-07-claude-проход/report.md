...
### B01 — Craving Log: клавиатура может перекрыть поле ввода на Android [MEDIUM]
**Файл:** `app/(modals)/craving-log.tsx:46`
**Что вижу:** Поле «Note» находится внизу экрана. `KeyboardAvoidingView` настроен только для iOS. На Android при открытии клавиатуры поле может оказаться под ней.
